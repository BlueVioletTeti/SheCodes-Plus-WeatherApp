function formatDate(date) {
  ...
  let formattedDate = `<strong>Today is ${currentMonth} ${currentDate}, ${currentYear}</strong></br>${currentDay}, ${currentHour}:${currentMinutes}`;
...
function showTemperature(response) {
  ...
  // sky description update
  let skyData = response.data.weather[0].main;
  let placeSkyData = document.querySelector("#sky-data");
  placeSkyData.innerHTML = `${skyData}`;
